    ...
    <footer>
      <div className="flex flex-wrap items-center py-4 px-4 border-b">
        ...
        <div className="w-full lg:w-3/5 mt-4 lg:mt-0 text-center">
          <a
            className="inline-block mx-4 mb-4 lg:mb-0 text-blue-900 hover:text-indigo-600"
            href="#"
          >
            Products
          </a>
      ...
      <div className="py-4 text-center">
        <span className="block md:inline-block mb-4 md:mb-0 mx-3">
          © 2020 Whatever Company This is For
        </span>
        <a
          className="inline-block mx-4 text-blue-900 hover:text-indigo-600"
          href="#"
        >
          Privacy Policy
        </a>
